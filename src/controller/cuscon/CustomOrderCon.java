...
import ui.adminuser.MyCustomAddrDia;
import ui.adminuser.MyCustomOrderSerDia;
...
public class CustomOrderCon implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
       ...
       // System.out.println("asd"+CrmCookies.getCookies("cus_id"));
        List<OrderDto> customList = orderServerImp.getOrderDtoById((Integer) Controller.cusRoot.getUserData());
    ...
    {
        MyDialog myDialog=new MyCustomAddrDia();
